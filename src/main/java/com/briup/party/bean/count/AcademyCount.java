...
public class AcademyCount {
    ...
    private List<BranchCount> branchCounts;
    public AcademyCount(){}
    public AcademyCount(String name, int storageNumber, int prepareNumber, int femaleNumber, int minorityNumber, int collegeNumber, List<BranchCount> branchCounts) {
        this.name = name;
    ...
    public List<BranchCount> getBranchCounts() {
        return branchCounts;
    }

    public void setBranchCounts(List<BranchCount> branchCounts) {
        this.branchCounts = branchCounts;
    }
